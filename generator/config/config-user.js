...
module.exports = {
  ...
  fields: [
    ...
    },
    {
      ...
      trim: true,
      required: false,
      description: '年龄', // 供swagger使用
      example: 18, // 供swagger使用
      comment: '年龄', // 数据库表中字段的描述
    },
    {
      name: 'sex',
      type: 'INTEGER',
      required: false,
      description: '状态：0.女、1.男、2.保密', // 供swagger使用
      example: 0, // 供swagger使用
      comment: '状态：0.女、1.男、2.保密', // 数据库表中字段的描述
      allowNull: false, // 是否允许为空
      defaultValue: 2, // 数据库表中字段的默认值
    },
    {
      name: 'sign',
      type: 'string',
      ...
      required: false,
      trim: true,
      description: '签名', // 供swagger使用
      example: '哥只是传说', // 供swagger使用
      comment: '签名', // 数据库表中字段的描述
    },
    {
      name: 'state',
      type: 'TINYINT',
